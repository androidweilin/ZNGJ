...
public class DateTimePicker implements OnClickListener {
    ...
    public DateTimePicker(Activity a,
        ...
        dialog = new Dialog(activity, R.style.DateTimeDialog);
    ...
    public View getDateTimePickerLayout() {
        ...
        button_params.leftMargin = 40;
        button_params.rightMargin = 40;
        ...
        btn_setDate.setTextColor(Color.parseColor("#ffffff"));
        btn_setDate.setId(SET_DATE);
        btn_setDate.setBackgroundResource(R.drawable.date_time_shape);
        btn_setDate.setOnClickListener(this);

        btn_setTime = new Button(activity);
        btn_setTime.setLayoutParams(button_params);
        btn_setTime.setText("设置时间");
        btn_setTime.setTextColor(Color.parseColor("#ffffff"));
        btn_setTime.setId(SET_TIME);
        btn_setTime.setBackgroundResource(R.drawable.date_time_shape);
        ...
        btn_set.setId(SET);
        btn_set.setBackgroundResource(R.drawable.date_time_shape);
        btn_set.setOnClickListener(this);

        btn_cancel = new Button(activity);
        btn_cancel.setLayoutParams(button_params);
        btn_cancel.setBackgroundResource(R.drawable.date_time_shape);
    ...
    /**
     * @param monthNumber Month Number starts with 0. For <b>January</b> it is <b>0</b>
    ...
    /**
     * @param weekDayNumber Week Number starts with 1. For <b>Sunday</b> it is <b>1</b>
